...
void Print(const int PJT_Name, const int Option){
	...
	case GLOBAL_PJT_SYSMAIN:  // SysMain
		...
		case GLOBAL_OPTION_TITLE:
			...
			cout << "	By Rabbit.white(정OO)" << endl;
			cout << "	OOOOOOOOOOOOOOOOOOOOO교" << endl;
			cout << "	Business & Computer Science	Engineering" << endl;
			cout << "	[메인 메뉴] / 2014. 11. 09" << endl;
			cout << "========================================================" << endl;
			cout << "(1번) integer" << endl;
			cout << "(2번) Double" << endl;
			cout << "(3번) Double(Polygon)" << endl;
			cout << "(4번) String" << endl;
			cout << "(5번) Linked Structure(연결구조)" << endl;
			cout << "(6번) About" << endl;
			cout << "(0번) EXIT" << endl;
			cout << "========================================================" << endl;
			cout << endl;
	...
	case GLOBAL_PJT_JPROGRAM: // JProgram
		...
		case GLOBAL_OPTION_TITLE:
			...
			cout << "Sort Wizard 마법사는 총 3단계로 구성됩니다." << endl;
			cout << "========================================================" << endl;
	...
	case GLOBAL_PJT_JAPP:
		...
		case GLOBAL_OPTION_TITLE:
			...
			cout << "(2번) Recursive Quick Sort" << endl;
			cout << "(3번) Recursive Median of Three Quick Sort" << endl;
			cout << "(4번) Non-Recursive Median of Three Quick Sort" << endl;
			cout << "(5번) STD::SORT - Quick Sort" << endl;
			cout << "(6번) Recursive Merge Sort" << endl;
			cout << "(7번) Non-Recursive Merge Sort" << endl;
			cout << "(8번) Natural Merge Sort" << endl;
			cout << "(9번) Heap Sort" << endl;
			cout << "(10번) Bubble Sort" << endl;
			cout << "(11번) Selection Sort" << endl;
			cout << "(0번) EXIT" << endl;
			cout << "========================================================" << endl;
			cout << endl;
			cout << "메뉴를 선택하세요: ";
