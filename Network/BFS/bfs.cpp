...
void Graph::Setup()
{
	HeadNodes[0].Insert(0); HeadNodes[0].Insert(1); // (0, 2), (0, 1)
	HeadNodes[1].Insert(0); HeadNodes[1].Insert(2); HeadNodes[1].Insert(3); // (1, 4), (1, 3), (1, 0)
	HeadNodes[2].Insert(1); HeadNodes[2].Insert(3); // (2, 6), (2, 5), (2, 0)
	HeadNodes[3].Insert(0);
